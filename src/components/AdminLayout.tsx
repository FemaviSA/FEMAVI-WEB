...
import { Package, ExternalLink, LogOut, Menu, X, ChevronRight, Mail, BookOpen, ClipboardList, Users, IdCard, CalendarRange } from 'lucide-react';
    ...
    <div className="min-h-screen flex bg-slate-50">
      ...
      >
        ...
        <nav className="flex-1 px-3 py-4 space-y-1">
          ...
          <NavLink to="/admin/vendedores" className={navItem}>
            <IdCard className="w-4 h-4" />
            <span className="flex-1">Vendedores</span>
          </NavLink>
          <NavLink to="/admin/ciclos" className={navItem}>
            <CalendarRange className="w-4 h-4" />
            <span className="flex-1">Ciclos</span>
          </NavLink>
