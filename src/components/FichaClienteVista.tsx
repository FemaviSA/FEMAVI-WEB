...
import BarrasPorAnio from './BarrasPorAnio';
...
// Ficha de un cliente del sistema viejo. La usan el admin y el vendedor: cada
// uno la pide a su propia función de la base, que decide qué puede ver.
